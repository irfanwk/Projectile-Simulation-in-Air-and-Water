...
# scene = vp.canvas(title="Simulasi 10 Proyektil", width=1920, height=1080, background=vp.color.white)
...
# projectiles = []
# for i in range(500): #parameter jumlah bola
#     mass        = 100 + i*50             # 100,150,...
#     elev_deg    = 20 + i*5               # 20,25,..
#     azim_deg    = i*36                   # 0°,36°, ...
#     power       = 2000 + i*400           # 2000,2400,...
#     elev_rad    = np.radians(elev_deg)
#     azim_rad    = np.radians(azim_deg)
#     v0_mag      = power / mass           # asumsi gaya berlangsung 1 detik
#     v0 = np.array([
...
projectiles = []
for i in range(30): #parameter jumlah bola
    mass        = 100 + i*50             # 100,150,...
    elev_deg    = 20 + i*5               # 20,25,...
    azim_deg    = i*36                   # 0°,36°, ...
    power       = 2000 + i*400           # 2000,2400,...
